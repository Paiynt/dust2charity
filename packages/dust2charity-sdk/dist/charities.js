export const CHARITIES = [
    {
        ...
        description: "Protects rainforests and supports Indigenous and local communities through conservation and advocacy. (Direct SOL transfer.)",
        mode: "direct",
    ...
    },
    {
        ...
        description: "Supports children worldwide with health, education, protection and emergency aid. (Donate via Giving Block.)",
        mode: "givingblock",
    ...
    },
    {
        ...
        description: "Free, 24/7 mental health support via text. (Donate via Giving Block.)",
        mode: "givingblock",
    ...
    },
    {
        id: "stand",
        name: "Stand.earth",
        description: "Climate and environmental campaigns for systemic change. (Donate via Giving Block.)",
        mode: "givingblock",
    ...
    },
    {
        ...
        description: "Fights global hunger by supporting the UN World Food Programme. (Donate via Giving Block.)",
        mode: "givingblock",
...
export function getCharity(id) {
    ...
    if (!c)
        throw new Error(`Unknown charity id: ${id}`);
    return c;
}
