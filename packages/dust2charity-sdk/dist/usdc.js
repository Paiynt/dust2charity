 ...
 */
export async function donateUsdc(args) {
    ...
    if (!recipientAtaInfo) {
        tx.add(createAssociatedTokenAccountInstruction(senderOwner, // payer
        recipientAta, // ata
    ...
    tx.add(createTransferCheckedInstruction(senderAta, mint, recipientAta, senderOwner, amountBaseUnits, USDC_DECIMALS));
    // Send + confirm
